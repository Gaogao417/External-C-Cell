...
CCompilerRegister[ $ThisDriver, {"Windows-x86-64"}]
...
MinGWCompiler["SupportedTargetSystemIDQ"]["Windows", ___] := False
...
$DefaultMinGWPaths = Flatten[
	Join[
		FileNames[{"msys64/mingw64", "MinGW64", "MinGW-w64"},
			FileNameJoin[{Environment["SystemDrive"]}]
		]
		,
		FileNames["*/mingw64",
			FileNameJoin[{Environment["ProgramFiles"], "mingw-w64"}]
		]
	]
];
