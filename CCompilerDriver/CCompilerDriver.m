...
CreateLibrary::system = CreateExecutable::system = CreateObjectFile::system = CCompilers::system =
    "Target system specification \"TargetSystemID\" -> `1` should be "<>
		Switch[$OperatingSystem,
			"Windows",
				"\"Windows\" or \"Windows-x86-64\"",
			"Unix",
			...
			"MacOSX",
				"\"MacOSX-x86\", \"MacOSX-x86-64\" or \"MacOSX-ARM64\""
		];

TransferProtocolLibrary::system = "Unable to resolve the name of the `2` transfer protocol library for TargetSystemID `1`."
...
CreateLibrary::instl = CreateExecutable::instl = CreateObjectFile::instl = "The compiler installation directive \"CompilerInstallation\" -> `1` does not indicate a usable installation of `2` (executable: `3`).";
...
CreateLibrary::tgtdir = CreateExecutable::tgtdir = CreateObjectFile::tgtdir = "Target directory specification \"TargetDirectory\" -> `1` should be a string or Automatic."
...
CreateLibrary::translib = CreateExecutable::translib = CreateObjectFile::translib = "TransferProtocolLibrary specification `1` is not Automatic, \"WSTP\" or \"MathLink\"."
...
(* Used by Compile with CompilationTarget -> "C" *)
$CCompilerInternalDirectory := $CCompilerInternalDirectory =
