...
(* The minimum legacy version detected by vswhere is 10.0 / VS 2010. *)
$vsVersionMap = <| 	"2010" -> "10", "2012" -> "11", "2013" -> "12",
					"2015" -> "14", "2017" -> "15", "2019" -> "16" |>;

VisualStudioCompiler["Installations"][versions : {_String...}] :=
		Module[{numvers = Lookup[$vsVersionMap, versions, Nothing]},
			If[$vswhereWorks
				,
				Pick[$vsPathTable, $vsVersionTable /. Thread[numvers -> True] /. _String -> False]
				,
				Map[installPath, Intersection[$VisualStudioVersions, versions]]
			]
		]
