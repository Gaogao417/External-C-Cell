...
$CompileOptions = {"SystemCompileOptions" :> {"-fPIC", $OptFlag}};
...
exeLinkLibraries["MacOSX-x86" | "MacOSX-x86-64" | "MacOSX-ARM64"] = "-lm -lpthread -lc++ -framework Foundation";
...
dllLinkLibs["MacOSX-x86" | "MacOSX-x86-64" | "MacOSX-ARM64"] = "-lc++ -framework Foundation";
dllLinkLibs[_] = "-lc++";

(* Determine the target architecture for compilation *)
compilerArchitectureOption["Linux-ARM"] = ""
compilerArchitectureOption["MacOSX-x86"] = "-arch i386";
compilerArchitectureOption["MacOSX-x86-64"] = "-arch x86_64";
compilerArchitectureOption["MacOSX-ARM64"] = "-arch arm64";
